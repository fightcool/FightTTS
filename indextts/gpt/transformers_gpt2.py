...
class GPT2PreTrainedModel(PreTrainedModel, GenerationMixin):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.

    Note: Explicitly inherits from GenerationMixin to maintain compatibility with transformers v4.50+
    """
